    ...
    <footer className="max-container">
        <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
            <div className="flex flex-col items-start">
                ...
                <p className="mt-6 text-base sm:text-pretty leading-7 font-montserrat text-white-400 sm:max-w-sm">
                    Subscribe to our newsletter for exclusive offers, early access to releases, and insider insights. Follow us on social media to join the conversation and share your #NikeMoments. Need assistance? Our dedicated support team is just a click away.
                </p>
